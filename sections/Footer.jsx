        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 pb-16">
          ...
          <div className="lg:col-span-5 flex flex-col items-center md:items-start gap-5 text-sm">
            ...
            >
              ...
              <span className="tracking-wide">+52 (624) 320-98-77</span>
              <span className="tracking-wide">+52 (624) 174-63-53</span>
            </a>
            ...
            >
              ...
              <span className="tracking-wide">booking@cabo101.com.mx</span>
            </a>
